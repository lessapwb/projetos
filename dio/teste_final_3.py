...
def prever_afinidade_elemental(intensidade, componente_raro, fase_lunar, idade_feiticeiro, afinidade_animais):
    ...
    elif intensidade >=7 and fase_lunar == "cheia" and componente_raro and idade_feiticeiro < 100 and not afinidade_animais:
        return "A afinidade elemental do feiticeiro é com o elemento Água!"
    elif intensidade >=7 and fase_lunar == "cheia" and componente_raro and idade_feiticeiro < 100:
